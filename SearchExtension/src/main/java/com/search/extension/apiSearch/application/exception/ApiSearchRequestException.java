 ...
 * CUSTOM CODE 생성 가능 
 */
public class ApiSearchRequestException extends ErrorResponseException {
	private static final long serialVersionUID = 1L;
	
	@Autowired 
	private  static HttpUtil httpUtil;

	public ApiSearchRequestException(String failMessage) {
	    super(HttpStatus.BAD_REQUEST, asProblemDetail(HttpStatus.BAD_REQUEST, "Error with Search : " + failMessage), null);
	}
	
	public ApiSearchRequestException(int customCode, String failMessage ) {
